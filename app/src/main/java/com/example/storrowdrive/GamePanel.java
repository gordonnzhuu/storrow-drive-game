...
public class GamePanel extends SurfaceView implements SurfaceHolder.Callback{
    ...
    private int currentSpeed = ConstantVar.RHETTSPEEDEASY;
    ...
    public GamePanel(Context context){
        ...
        Bitmap redChair = BitmapFactory.decodeResource(getResources(), R.drawable.redchair);
        ConstantVar.REDCHAIR = Bitmap.createScaledBitmap(redChair, (ConstantVar.WIDTH/5), (ConstantVar.HEIGHT/7), false);
        Bitmap blueChair = BitmapFactory.decodeResource(getResources(), R.drawable.bluechair);
        ConstantVar.BLUECHAIR = Bitmap.createScaledBitmap(blueChair, (ConstantVar.WIDTH/5), (ConstantVar.HEIGHT/7), false);
        Bitmap brownChair = BitmapFactory.decodeResource(getResources(), R.drawable.brownchair);
        ConstantVar.BROWNCHAIR = Bitmap.createScaledBitmap(brownChair, (ConstantVar.WIDTH/5), (ConstantVar.HEIGHT/7), false);
        Bitmap rainbowChair = BitmapFactory.decodeResource(getResources(), R.drawable.rainbowchair);
        ConstantVar.RAINBOWCHAIR = Bitmap.createScaledBitmap(rainbowChair, (ConstantVar.WIDTH/5), (ConstantVar.HEIGHT/7), false);
